...
//eğer text yoksa o zaman main class ına hidden koyacak yani note görünmeyecek, eğer text varsa yani herhangibir note varsa o zaman hidden olmayacak ve kart görünecek
    ...
    <div class="tools">
        ...
        <button class="font"><i class="fas fa-font"></i></button>
...
//bir üstte note oluşturduk şimdi o note lardaki tools lara erişelim
    ...
    const colorEl = note.querySelector('.color')
    const fontEl = note.querySelector('.font')
...
// let bgcolor = note.style.backgroundColor;
// colorEl.addEventListener('change', (e) => {
//    note.style.backgroundColor = e.target.value
// console.log(target.value)
// bgcolor = e.target.value
// })
colorEl.addEventListener('change', bgchange)
...
fontEl.addEventListener('click',bigFont)

function bigFont(){
    note.style.fontSize = '35px'
